...
* **核心积分代币：** [**UPT**](/outstake/yield-tokenization/upt.md) 是贯穿 Outrun 生态系统的**核心基础稳定币代币**。它通过将生息代币质押到 OutStake 模块来铸造，并且是 **Memeverse 发射的 Memecoin 交易对的配对代币**。因此，OutStake 和 Memeverse 模块的积分分配机制与 UPT 的采用息息相关。
