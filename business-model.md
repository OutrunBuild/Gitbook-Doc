...
* **OutStake**: 收入主要来自于质押生息代币的收益佣金和 SP, PYT 的交易手续费。
* **OutSwap**: 收入主要来源于交易手续费，随着流动性和交易量的增加而增强。
* **FFLaunch 和 Memeverse**: 主要定位是流量入口与资产发行，以提升 Outrun 生态系统的 TVL 及潜在收入。

### **网络效应: Outrun 的增长催化剂**

Outrun 生态系统的网络效应体现在以下几个方面：

* **流动性连接**: OutStake 的通用资产本金代币 ([UPT](outstake/yield-tokenization/upt.md)) 将相同底层资产类型的不同生息代币的流动性打通，从而提升整个 LSD 生态的流动性，创造了巨大的网络效应。
* **推荐返佣引擎**: OutSwap 的链上推荐返佣引擎增强了流动性支持，并引导更多的交易发生，从而提升了交易量和手续费收入，并且还会带来更多的社交影响力。
* **用户吸引**: FFLaunch 和 Memeverse 的设计理念旨在吸引大量用户，显著提高用户粘性，并满足各个利益方的需求，促成共赢的局面，从而提升整个生态系统的网络效应和收入潜力。同时还能帮助销毁 UPT 来提升对 OutStake 的需求，吸引更多人参与 Outrun 生态系统，形成增长飞轮。
