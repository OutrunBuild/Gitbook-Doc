...
Each Memecoin has a corresponding yield vault on the **Governance Chain** that complies with the **ERC4626** standard. Memecoin holders can deposit their tokens into these vaults to mint **yield-bearing tokens** based on Memecoin. The vault's revenue primarily comes from **the Memecoin portion of the locked-liquidity market-making income** (ERC4626 vault income is limited to the Memecoin portion of the market-making income, while the UPT portion belongs to the **Memecoin DAO treasury**).
