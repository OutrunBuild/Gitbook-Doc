...
YT 同时也是一种与利率挂钩的非美元算法稳定币，理论上 1 个 YT 代表 1 个生息代币 1 天所产生的利息收益。由于 YT 与利率挂钩，并且也是由生息代币质押所铸造的，不同于早期 Luna 这类算法稳定币，YT 的价值系统是一个封闭的系统，永远不会出现价格死亡螺旋的情况
...
YT 不仅仅是帮助长期质押者获得更多收益的工具，它是一个真正的通用同质化 Yield Token，同时也是 **Web3 第一个锚定利率的去中心化算法稳定币**，在市场的博弈下 YT 始终与利率挂钩，在未来 Outrun 会依托 YT 的特性和社区一起构建更多有意思的产品。
