...
OutStake 的 PT 是通用资产本金代币（**UPT**），质押相同资产类型的原生收益代币会铸造同一种通用资产本金代币，简单讲 质押 stETH，rETH，stone 会铸造同一种 PT 代币，而非不同的 PT 代币。这样的设计可以使相同类别的原生收益代币共享 PT 的流动性，并提高其可组合性。
...
同时 UPT 将使用 ERC7281(xERC20) 标准，使其成为全链代币。
